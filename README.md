...
## Open-ended speech (optional)

The built-in grammar handles standard phraseology instantly and offline. For
anything it was never taught, the game can hand the transmission to a
language model and translate what comes back into the same instructions.

It is off until you point it at an endpoint:
